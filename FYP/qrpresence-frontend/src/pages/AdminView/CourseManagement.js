...
const CourseManager = () => {
    ...
    return (_jsxs("div", { className: "course-manager", children: [_jsx("div", { className: "course-manager__header", children: _jsx("h2", { children: "Course Management" }) }), _jsx("div", { className: "course-manager__search", children: _jsxs("div", { className: "search-group", children: [_jsx(Search, { size: 18 }), _jsx("input", { type: "text", placeholder: "Search courses...", value: searchTerm, onChange: (e) => setSearchTerm(e.target.value), className: "search-input" })] }) }), error && (_jsxs("div", { className: "admin-error", children: [_jsx("p", { children: error }), _jsx("button", { onClick: fetchCourses, className: "admin-button admin-button--primary", children: "Retry" })] })), _jsxs("div", { className: "admin-table-container", children: [_jsxs("table", { className: "admin-table", children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { children: "Course Code" }), _jsx("th", { children: "Title" }), _jsx("th", { children: "Credited Hours" }), _jsx("th", { children: "Created By" }), _jsx("th", { children: "Creation Date" }), _jsx("th", { children: "Actions" })] }) }), _jsx("tbody", { children: filteredCourses.map((course) => (_jsxs("tr", { children: [_jsx("td", { children: _jsxs("div", { className: "course-code", children: [_jsx(BookOpen, { size: 16 }), course.code] }) }), _jsx("td", { children: course.title }), _jsx("td", { children: course.credit_hours }), _jsx("td", { children: course.created_by }), "  ", _jsx("td", { children: new Date(course.created_at).toLocaleDateString() }), _jsx("td", { children: _jsxs("div", { className: "action-buttons", children: [_jsx("button", { className: "action-button action-button--edit", title: "Edit Course", children: _jsx(Edit, { size: 16 }) }), _jsx("button", { className: "action-button action-button--delete", onClick: () => handleDeleteCourse(course.id), title: "Delete Course", children: _jsx(Trash2, { size: 16 }) })] }) })] }, course.id))) })] }), filteredCourses.length === 0 && !loading && (_jsx("div", { className: "admin-table-empty", children: _jsx("p", { children: "No courses found" }) }))] })] }));
};
