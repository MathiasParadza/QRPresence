...
const App = () => {
    ...
    return (_jsx(Router, { children: _jsxs(Routes, { children: [_jsx(Route, { path: "/", element: _jsx(HomePage, {}) }), _jsx(Route, { path: "/register", element: _jsx(Register, {}) }), _jsx(Route, { path: "/login", element: _jsx(Login, { setUser: setUser }) }), _jsx(Route, { path: "/generate-qr", element: _jsx(QRCodeGenerator, {}) }), _jsx(Route, { path: "/create-session", element: user && user.role === "lecturer" ? (_jsx(CreateSession, {})) : (_jsx(Navigate, { to: "/login" })) }), _jsx(Route, { path: "/session-list", element: user && user.role === "lecturer" ? (_jsx(SessionList, {})) : (_jsx(Navigate, { to: "/login" })) }), _jsx(Route, { path: "/lecturer/sessions/edit/:id", element: user && user.role === "lecturer" ? (_jsx(SessionEdit, {})) : (_jsx(Navigate, { to: "/login" })) }), _jsx(Route, { path: "/student-manager", element: user && user.role === "lecturer" ? (_jsx(StudentManager, {})) : (_jsx(Navigate, { to: "/login" })) }), _jsx(Route, { path: "/dashboard", element: user ? _jsx(Dashboard, {}) : _jsx(Navigate, { to: "/login" }) }), _jsx(Route, { path: "/lecturerview", element: user && user.role === "lecturer" ? (_jsx(ErrorBoundary, { children: _jsx(LecturerView, {}) })) : (_jsx(Navigate, { to: "/login" })) }), _jsx(Route, { path: "/studentview", element: user && user.role === "student" ? (_jsx(StudentView, {})) : (_jsx(Navigate, { to: "/login" })) }), _jsx(Route, { path: "/ai-assistant", element: user ? _jsx(AIChatAssistant, {}) : _jsx(Navigate, { to: "/login" }) }), _jsx(Route, { path: "*", element: _jsx(Navigate, { to: "/" }) })] }) }));
};
export default App;
